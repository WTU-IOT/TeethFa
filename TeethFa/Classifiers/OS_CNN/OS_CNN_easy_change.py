...
class OS_CNN_easy_change():
    ...
    def __init__(self, Result_log_folder,
        ...
        super(OS_CNN_easy_change, self).__init__()
    ...
    def fit(self, X_train, y_train, X_val, y_val):
        ...
        # train_loader = DataLoader(train_dataset, batch_size=max(int(min(X_train.shape[0] / 10, self.batch_size)), 2),
        #                           shuffle=True)
        # test_dataset = TensorDataset(X_test, y_test)
        # test_loader = DataLoader(test_dataset, batch_size=max(int(min(X_train.shape[0] / 10, self.batch_size)), 2),
        #                          shuffle=False)
        #
        # torch_OS_CNN.train()
        #
    ...
    def predict(self, X_test):
        ...
        test_loader = DataLoader(test_dataset, batch_size=max(int(min(X_test.shape[0] / 10, self.batch_size)), 2),
                                 shuffle=False)
